<template>
	...
	>
		...
		<div
			class="w-full min-h-[220px] rounded-xl flex flex-col justify-end pb-3 items-center bg-gray-900 flex-end"
		>
			<span class="text-white px-5 text-center capitalize font-medium"
